...
\TirName{TypLetMut} introduces a new mutable local variable,
...
\typctx{\Gamma}\typsc\typctx{\Delta}\typderive\synif\synvar{e}\synthen\synlbracket\synvar{s_1}\synscellipsis\synvar{s_n}\synrbracket\typtyped\synunitt\typproduce\typctx{\Gamma}
}
\end{mathpar}
\begin{mathpar}
...
\typctx{\Gamma}\typsc\typctx{\Delta}\typderive\synif\synvar{e}\synthen\synlbracket\synvar{s_1}\synscellipsis\synvar{s_n}\synrbracket\synelse\synlbracket\synvar{s'_1}\synscellipsis\synvar{s'_n}\synrbracket\typtyped\synunitt\typproduce\typctx{\Gamma}
}
\end{mathpar}
\begin{mathpar}
...
Statements evaluation&\synvar{p}\evasc\evactx{\Omega}\evaderive\synvar{s_1}\synellipsis\synvar{s_n}\evaeval\synvar{v}\evaproduce\evactx{\Omega}
\\\bottomrule
\end{tabular}
\begin{mathpar}
\inferrule[EvalUnit]{
...
\synfn\synvar{f}\synlparen \synvar{x_1}\syntyped\synvar{\tau_1}\synellipsis\synvar{x_n}\syntyped\synvar{\tau_n}\synrparen\synarrow\synvar{\mu}\synlbracket \synvar{s_1}\synellipsis\synvar{s_m}\synrbracket\in\synvar{p}\\
\forall i\in[\![1,n]\!],\; \synvar{p}\evasc\evactx{\Omega}\evaderive\synvar{a_i}\evaeval\synvar{v_i}\\
\synvar{p}\evasc\synvar{x_1}\evamapsto\synvar{v_1}\evaellipsis\synvar{x_n}\evamapsto\synvar{v_n}\evasc\evaempty\evaderive\synvar{s_1}\synellipsis\synvar{s_m}\evaeval\synvar{v}
}{
...
\synvar{p}\evasc\evactx{\Omega}\evaderive\synvar{s_1}\synellipsis\synvar{s_n}\evaeval\synunit\evaproduce\evactx{\Gamma'}
}{
\synvar{p}\evasc\evactx{\Omega}\evaderive\synif\synvar{e_1}\;\synlbracket\synvar{s_1}\synellipsis\synvar{s_n}\synrbracket\evaeval\synunit\evaproduce\evactx{\Gamma'}
}
...
\synvar{p}\evasc\evactx{\Omega}\evaderive\synif\synvar{e_1}\;\synlbracket\synvar{s_1}\synellipsis\synvar{s_n}\synrbracket\synelse\synlbracket\synvar{s'_1}\synellipsis\synvar{s'_n}\synrbracket\evaeval\synunit\evaproduce\evactx{\Gamma'}
}

\inferrule[EvalIfThenElseFalse]{
\synvar{p}\evasc\evactx{\Omega}\evaderive\synvar{e_1}\evaeval\synfalse\\
\synvar{p}\evasc\evactx{\Omega}\evaderive\synvar{s'_1}\synellipsis\synvar{s'_n}\evaeval\synunit\evaproduce\evactx{\Gamma'}
}{
\synvar{p}\evasc\evactx{\Omega}\evaderive\synif\synvar{e_1}\;\synlbracket\synvar{s_1}\synellipsis\synvar{s_n}\synrbracket\synelse\synlbracket\synvar{s'_1}\synellipsis\synvar{s'_n}\synrbracket\evaeval\synunit\evaproduce\evactx{\Gamma'}
}
...
\forall i\in[\![n,m-1]\!],\;\synvar{p}\evasc\evactx{\Omega_i}\evaderive\synvar{s_1}\synellipsis\synvar{s_n}\evaeval \synunit\evaproduce\evactx{\Omega_{i+1}}\\
}{
\synvar{p}\evasc\evactx{\Omega}\evaderive\synfor\synvar{x}\synin\synvar{e_1}\synrange\synvar{e_2}\;\synlbracket\synvar{s_1}\synellipsis\synvar{s_n}\synrbracket\evaeval\synunit\evaproduce\evactx{\Omega_m}
}
