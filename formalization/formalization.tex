...
Statement sequence typing&\typctx{\Gamma}\typsc\typctx{\Delta}\typderive\synvar{s_1}\synscellipsis\synvar{s_n}\typproduce\typctx{\Gamma'}
\\\bottomrule
\end{tabular}
\begin{mathpar}
\inferrule[TypLet]{
...
\typctx{\Gamma}\typsc\typctx{\Delta}\typderive\synlet\synvar{x}\syntyped\synvar{\tau}\syneq\synvar{e}\typproduce\typctx{\Gamma}\typcomma\synvar{x}\typtyped\synvar{\tau}
}

\inferrule[TypLetMut]{
\typctx{\Gamma}\typsc{\typctx{\Delta}}\typderive\synvar{e}\typtyped\synvar{\tau}
}{
\typctx{\Gamma}\typsc\typctx{\Delta}\typderive\synlet\synmut\synvar{x}\syntyped\synvar{\tau}\syneq\synvar{e}\typproduce\typctx{\Gamma}\typcomma\synvar{x}\typtyped\synvar{\tau}
}

\inferrule[TypReassign]{
\typctx{\Gamma}\typcomma\synvar{x}\typtyped\synvar{\tau}\typsc{\typctx{\Delta}}\typderive\synvar{e}\typtyped\synvar{\tau}
}{
\typctx{\Gamma}\typcomma\synvar{x}\typtyped\synvar{\tau}\typsc{\Delta}\typderive\synvar{x}\syneq\synvar{e}\typproduce\typctx{\Gamma}
}
...
\typctx{\Gamma}\typsc\synvar{t}\typarrow\typlsquare\synvar{\mu}\typsc n\typrsquare\typcomma\typctx{\Delta}\typderive \synvar{e_1}\synlsquare\synvar{e_2}\synrsquare\syneq\synvar{e_3}\typproduce\typctx{\Gamma}
}
...
\typctx{\Gamma}\typsc\typctx{\Delta}\typderive \synvar{e_1}\synlsquare\synvar{e_2}\synrsquare\syneq\synvar{e_3}\typproduce\typctx{\Gamma}
}
\end{mathpar}
\end{center}
