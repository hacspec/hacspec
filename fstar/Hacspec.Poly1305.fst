...
type poly1305_tag = lseq (uint8) (usize 16)
...
let poly1305_encode_last (pad_len_5: block_index) (b_6: sub_block) : field_element =
  let n_7 =
...
let poly1305_update_last (pad_len_22: uint_size) (b_23: sub_block) (st_24: poly_state) : poly_state =
  let st_25 = st_24 in
  let st_25 =
...
let poly1305_finish (st_33: poly_state) : poly1305_tag =
...
let poly1305 (m_39: byte_seq) (key_40: poly_key) : poly1305_tag =
