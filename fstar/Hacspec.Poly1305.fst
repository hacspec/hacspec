...
let poly1305_update (m_29 : byte_seq) (st_30 : poly_state) : poly_state =
  ...
  in
  let last_32 =
    seq_get_remainder_chunk (m_29) (blocksize)
  in
...
let poly1305_finish (st_33 : poly_state) : tag =
  ...
  in
  let aby_37 =
    nat_to_byte_seq_le (0x03fffffffffffffffffffffffffffffffb) (acc_34)
  in
  let a_38 =
    uint128_from_le_bytes (
