...
let ntru_prime_653_decrypt
  (c_1861 : seq pub_int128)
  (key_f_1862 : seq pub_int128)
  (key_v_1863 : seq pub_int128)
  : (seq pub_int128 & bool) =
  ...
  let (f_3_c_1872) =
    foldi (usize 0) (seq_len #pub_int128 (f_3_c_1872)) (fun (
        i_1874,
        (f_3_c_1872)
      ) ->
      let (f_3_c_1872) =
    ...
    (f_3_c_1872)
  in
  let e_1875 = seq_new_ #pub_int128 (seq_len #pub_int128 (f_3_c_1872)) in
  let (e_1875) =
