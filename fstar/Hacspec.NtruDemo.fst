...
let build_irreducible (p_1842 : usize) : RSeq.seq pub_int128 =
  let irr_1843 = RSeq.new_ #pub_int128 (p_1842 + (pub_u32 1ul)) in
  let irr_1843 = array_upd irr_1843 ((pub_u32 0ul)) (- (pub_i128 0x1)) in
  let irr_1843 = array_upd irr_1843 ((pub_u32 1ul)) (- (pub_i128 0x1)) in
...
let round_to_3
  ...
  let (result_1846) =
    foldi ((pub_u32 0ul)) (len (poly_1844)) (fun (i_1848, (result_1846)) ->
      let (result_1846) =
  ...
  in
  let (result_1846) =
    foldi ((pub_u32 0ul)) (len (result_1846)) (fun (i_1849, (result_1846)) ->
      let (result_1846) =
...
let ntru_prime_653_encrypt
  ...
  : RSeq.seq pub_int128 =
  let p_1857 = (pub_u32 653ul) in
  let q_1858 = (pub_i128 0x120d) in
  let w_1859 = (pub_u32 288ul) in
...
let ntru_prime_653_decrypt
  ...
  let p_1864 = (pub_u32 653ul) in
  let q_1865 = (pub_i128 0x120d) in
  let w_1866 = (pub_u32 288ul) in
  ...
  let (f_3_c_1872) =
    foldi ((pub_u32 0ul)) (len (f_3_c_1872)) (fun (i_1874, (f_3_c_1872)) ->
      let (f_3_c_1872) =
  ...
  let (e_1875) =
    foldi ((pub_u32 0ul)) (len (e_1875)) (fun (i_1876, (e_1875)) ->
      let e_1875 =
  ...
  in
  let (r_1877) =
    foldi ((pub_u32 0ul)) (len (r_1877)) (fun (i_1878, (r_1877)) ->
      let (r_1877) =
