...
type lseq (a: Type) (len: uint_size) = LSeq.lseq a (v len)

(**** Array manipulation *)

assume val new_ (#a: Type) (len: uint_size) (_: unit) : lseq a len

assume val array_index (#a: Type) (#len: uint_size) (s: lseq a len) (i: uint_size{UInt32.v i < UInt32.v len}) : a

assume val array_upd (#a: Type) (#len: uint_size) (s: lseq a len) (i: uint_size{UInt32.v i < UInt32.v len})
 (new_v: a) : lseq a len
