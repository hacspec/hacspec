...
noeq type error =
| InvalidTag_error : error

type cha_cha_poly_key = cha_cha_key

type cha_cha_poly_iv = cha_cha_iv

type byte_seq_result = (result byte_seq error)

let init (key_0 : cha_cha_poly_key) (iv_1 : cha_cha_poly_iv) : poly_state =
  let key_block0_2 =
    chacha20_key_block0 (key_0) (iv_1)
  in
  let poly_key_3 =
    array_from_slice (secret (pub_u8 0x0)) (32) (key_block0_2) (usize 0) (
      usize 32)
  in
...
let poly1305_update_padded (m_4 : byte_seq) (st_5 : poly_state) : poly_state =
  let st_6 =
    poly1305_update_blocks (m_4) (st_5)
  in
  let last_7 =
    seq_get_remainder_chunk (m_4) (usize 16)
  in
...
let finish
  ...
  : poly1305_tag =
  let last_block_11 =
    array_new_ (secret (pub_u8 0x0)) (16)
  in
  let last_block_11 =
    array_update (last_block_11) (usize 0) (
      uint64_to_le_bytes (secret (pub_u64 (aad_len_8))))
  in
  let last_block_11 =
    array_update (last_block_11) (usize 8) (
      uint64_to_le_bytes (secret (pub_u64 (cipher_len_9))))
  in
  let st_12 =
    poly1305_update_block (last_block_11) (st_10)
  in
...
let chacha20_poly1305_encrypt
  ...
  let cipher_text_17 =
    chacha20 (key_13) (iv_14) (pub_u32 0x1) (msg_16)
  in
  let poly_st_18 =
    init (key_13) (iv_14)
  in
  let poly_st_18 =
    poly1305_update_padded (aad_15) (poly_st_18)
  in
  let poly_st_18 =
    poly1305_update_padded (cipher_text_17) (poly_st_18)
  in
  let tag_19 =
    finish (seq_len (aad_15)) (seq_len (cipher_text_17)) (poly_st_18)
  in
...
let chacha20_poly1305_decrypt
  ...
  in
  let poly_st_25 =
    poly1305_update_padded (aad_22) (poly_st_25)
  in
  let poly_st_25 =
    poly1305_update_padded (cipher_text_23) (poly_st_25)
  in
  let my_tag_26 =
    finish (seq_len (aad_22)) (seq_len (cipher_text_23)) (poly_st_25)
  in
  if (array_declassify_eq (my_tag_26) (tag_24)) then (
    Ok (chacha20 (key_20) (iv_21) (pub_u32 0x1) (cipher_text_23))) else (
    Err (InvalidTag_error))
