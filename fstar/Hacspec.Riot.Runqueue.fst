...
let clist_push
  (x_9: clist)
  (n_10: thread_id{(**) tid_v n_10 < n_threads})
  (rq_11: runqueue_id{(**) rq_v rq_11 < n_queues}) : clist =
    ...
    then
      let tail_14, next_idxs_15 =
        ...
        then
          ...
          (**) let _ = assume(v (array_index (tail_14) (v (cast U32 PUB (rq_12)))) < n_threads) in
          let next_idxs_15 =
...
let clist_pop_head
  (x_16: clist)
  (rq_17: runqueue_id{(**) rq_v rq_17 < n_queues})
  ...
  let tail_19, next_idxs_20, out_21 =
    ...
    then (tail_19, next_idxs_20, out_21)
      ...
      (**) let _ = assume(v (array_index (tail_19) (v (cast U32 PUB (rq_18)))) < n_threads) in
      let head_22 =
        array_index (next_idxs_20)
          (v (cast U32 PUB (array_index (tail_19) (v (cast U32 PUB (rq_18))))))
      in
      (**) let _ = assume(v head_22 < n_threads) in
...
let clist_peek_head
  (x_23: clist)
  (rq_24: runqueue_id{(**) rq_v rq_24 < n_queues})
    : (option pub_uint8) =
  ...
  then (None)
    ...
    (**) let _ = assume(v (array_index (tail_26) (v (cast U32 PUB (rq_25)))) < n_threads) in
    (Some
...
let clist_advance
  (x_28: clist)
  (rq_29: runqueue_id{rq_v rq_29 < n_queues})
    : clist =
  ...
  let tail_31 =
    ...
    then
      (**) let _ = assume(v (array_index (tail_31) (v (cast U32 PUB (rq_30)))) < n_threads) in
      let tail_31 =
        array_upd tail_31
...
let runqueue_add
  (y_33: run_queue)
  (n_34: thread_id{(**) tid_v n_34 < n_threads})
  (rq_35: runqueue_id{(**) rq_v rq_35 < n_queues})
    : run_queue =
...
let runqueue_del
  (y_39: run_queue)
  (n_40: thread_id{(**) tid_v n_40 < n_threads})
  (rq_41: runqueue_id{(**) rq_v rq_41 < n_queues})
    : run_queue =
...
let runqueue_advance
  (y_54: run_queue)
  (rq_55: runqueue_id{(**) rq_v rq_55 < n_queues})
    : run_queue =
