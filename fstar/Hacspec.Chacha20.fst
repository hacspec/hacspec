...
let state_idx = nat_mod (usize 16)

type constants = lseq (uint32) (usize 4)

let constants_idx = nat_mod (usize 4)
...
let chacha20_line (a_0 b_1 d_2: state_idx) (s_3: uint_size) (m_4: state) : state =
  let state_5 = m_4 in
  let state_5 =
...
let chacha20_quarter_round (a_6 b_7 c_8 d_9: state_idx) (state_10: state) : state =
...
let chacha20_init (key_30: cha_cha_key) (iv_31: cha_cha_iv) (ctr_32: uint32) : state =
...
let chacha20_encrypt_block (st0_39: state) (ctr_40: uint32) (plain_41: block) : block =
...
let chacha20_encrypt_last (st0_45: state) (ctr_46: uint32) (plain_47: byte_seq) : byte_seq =
...
let chacha20 (key_58: cha_cha_key) (iv_59: cha_cha_iv) (ctr_60: pub_uint32) (m_61: byte_seq)
    : byte_seq =
