...
fn translate_item<'a>(
    ...
    match &item.item {
        Item::FnDecl((f, _), sig, (b, _)) => {
            ...
            translate_ident(Ident::TopLevel(f.clone())).append(RcDoc::as_string("_pure"))
                .append(RcDoc::line())
            ...
            None,
            rustspec_to_coq_ssprove_pure::translate_block(b.clone(), false, top_ctx)
                .append(RcDoc::nil())
                .group(),
            true,
        ))
                ...
                .append(RcDoc::line())
                .append(
                    rustspec_to_coq_ssprove_pure::make_let_binding(
                        ...
                        RcDoc::as_string("{|")
                            ...
                            .append(translate_ident(Ident::TopLevel(f.clone())).append(RcDoc::as_string("_pure"))).append(if sig.args.len() > 0 {
                                RcDoc::intersperse(
                                    sig.args.iter().map(|((x, _), (tau, _))| {
                                        make_paren(
                                            translate_ident(x.clone())
                            ...
                            .append(translate_ident(Ident::TopLevel(f.clone())).append(RcDoc::as_string("_state"))).append(if sig.args.len() > 0 {
                                RcDoc::intersperse(
                                    sig.args.iter().map(|((x, _), (tau, _))| {
                                        make_paren(
                                            translate_ident(x.clone())
                ...
                .append(RcDoc::space())
                .append(translate_ident(Ident::TopLevel(f.clone())).append(RcDoc::as_string("_eq :")))
                .append(RcDoc::line())
                ...
                .append(RcDoc::as_string(","))
                .append(RcDoc::line())
                .append(RcDoc::as_string("code_eq_proof_statement"))
                .append(RcDoc::space())
                .append(make_paren(translate_ident(Ident::TopLevel(f.clone()))
                .append(if sig.args.len() > 0 {
                                RcDoc::intersperse(
                                    sig.args.iter().map(|((x, _), (tau, _))| {
                                        make_paren(
