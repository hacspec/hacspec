...
// Import aes and gcm
use crate::aes;
use crate::aes::{aes128_ctr_keyblock, aes128_decrypt, aes128_encrypt, aes256_encrypt, aes256_ctr_keyblock, aes256_decrypt, Block};
...
pub fn encrypt_aes128(key: aes::Key128, iv: aes::Nonce, aad: ByteSeq, msg: ByteSeq) -> (ByteSeq, Tag) {
...
pub fn encrypt_aes256(key: aes::Key256, iv: aes::Nonce, aad: ByteSeq, msg: ByteSeq) -> (ByteSeq, Tag) {
    let iv0 = aes::Nonce::new();
