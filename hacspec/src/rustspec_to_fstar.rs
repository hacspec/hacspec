...
fn translate_base_typ(tau: &BaseTyp) -> RcDoc<()> {
    match tau {
        ...
        //TODO: use the label ?
        BaseTyp::UInt8(_label) => RcDoc::as_string("UInt8.t"),
        BaseTyp::Int8(_label) => RcDoc::as_string("Int8.t"),
        BaseTyp::UInt16(_label) => RcDoc::as_string("UInt16.t"),
        BaseTyp::Int16(_label) => RcDoc::as_string("Int16.t"),
        BaseTyp::UInt32(_label) => RcDoc::as_string("UInt32.t"),
        BaseTyp::Int32(_label) => RcDoc::as_string("Int32.t"),
        BaseTyp::UInt64(_label) => RcDoc::as_string("UInt64.t"),
        BaseTyp::Int64(_label) => RcDoc::as_string("Int64.t"),
        BaseTyp::UInt128(_label) => RcDoc::as_string("UInt128.t"),
        BaseTyp::Int128(_label) => RcDoc::as_string("Int128.t"),
...
fn translate_literal(lit: &Literal) -> RcDoc<()> {
    match lit {
        ...
        Literal::Int128(x, _) => RcDoc::as_string(format!("Int128.uint_to_t {}", x)),
        Literal::UInt128(x, _) => RcDoc::as_string(format!("UInt128.uint_to_t {}", x)),
        Literal::Int64(x, _) => RcDoc::as_string(format!("{}L", x)),
        Literal::UInt64(x, _) => RcDoc::as_string(format!("{}UL", x)),
        Literal::Int32(x, _) => RcDoc::as_string(format!("{}l", x)),
        Literal::UInt32(x, _) => RcDoc::as_string(format!("{}ul", x)),
        Literal::Int16(x, _) => RcDoc::as_string(format!("{}s", x)),
        Literal::UInt16(x, _) => RcDoc::as_string(format!("{}us", x)),
        Literal::Int8(x, _) => RcDoc::as_string(format!("{}y", x)),
        Literal::UInt8(x, _) => RcDoc::as_string(format!("{}uy", x)),
    ...
    match prefix {
        ...
        Some((prefix, _)) => {
            let module_name = match prefix {
                ...
                BaseTyp::UInt8(_label) => RcDoc::as_string("UInt8"),
                BaseTyp::Int8(_label) => RcDoc::as_string("Int8"),
                BaseTyp::UInt16(_label) => RcDoc::as_string("UInt16"),
                BaseTyp::Int16(_label) => RcDoc::as_string("Int16"),
                BaseTyp::UInt32(_label) => RcDoc::as_string("UInt32"),
                BaseTyp::Int32(_label) => RcDoc::as_string("Int32"),
                BaseTyp::UInt64(_label) => RcDoc::as_string("UInt64"),
                BaseTyp::Int64(_label) => RcDoc::as_string("Int64"),
                BaseTyp::UInt128(_label) => RcDoc::as_string("UInt128"),
                BaseTyp::Int128(_label) => RcDoc::as_string("Int128"),
