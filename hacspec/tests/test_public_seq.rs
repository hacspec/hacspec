...
fn test_byte_sequences() {
    ...
    let msg_u32 = PublicSeq::<u32>::from_slice(&[0x0388dace, 0x60b6a392, 0xf328c2b9, 0x71b2fe78]);
...
#[test]
fn test_seq_poly() {
    let x = PublicSeq::<u128>::from_slice(&[5, 2, 7, 8, 9]);
    let y = PublicSeq::<u128>::from_slice(&[2, 1, 0, 2, 4]);
