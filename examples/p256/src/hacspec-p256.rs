...
pub use creusot::*;
// #[cfg(not(feature = "hacspec"))]
// pub use creusot_contracts::{ensures, logic, pearlite, requires, predicate, trusted};
...
// #[cfg(not(feature = "hacspec"))]
// impl Model for FieldCanvas {
//     type ModelTy = creusot_contracts::Int;
//     #[logic]
...
// #[trusted]
// #[ensures(@result == a)]
// fn field_canvas(a: u64) -> FieldCanvas {
//   FieldCanvas::from_literal(a)
// }

// impl OrdLogic for FieldCanvas {
//     #[logic]
//     fn cmp_log(s : FieldCanvas, o: Self) -> Ordering {
//         if s < o {
//             Ordering::Less
//         } else if s == o {
//             Ordering::Equal
...
// // pub fn t(x: FieldCanvas, y: FieldCanvas) -> FieldCanvas {
// //     if x <= y { x } else { y }
// // }
...
// impl FieldCanvas {
//     #[cfg(not(feature = "std"))]
//     fn ord_cmp(&self, other: &FieldCanvas) -> core::cmp::Ordering {
//         let signed_cmp =
//             if (*self).signed {
//                 if (*other).signed {
...
//             (Sign::Minus, Sign::Minus) => ord_cmp_seq(&(*other).b, &(*self).b),
//             (Sign::Minus, _) => core::cmp::Ordering::Less,
//             (Sign::NoSign, Sign::NoSign) => core::cmp::Ordering::Equal,
//             (Sign::Plus, Sign::Plus) => ord_cmp_seq(&(*self).b, &(*other).b),
...
// pub fn mul (x : FieldCanvas , y : FieldCanvas) -> FieldCanvas {
//     x * y
// }
...
// //             } else {
// //                 let h = u2 - u1;
// //                 let i = (P256FieldElement::from_literal(2u64) * h).exp(2u32);
// //                 let j = h * i;
// //                 let r = P256FieldElement::from_literal(2u64) * (s2 - s1);
// //                 let v = u1 * i;

// //                 let x3_1 = P256FieldElement::from_literal(2u64) * v;
// //                 let x3_2 = r.exp(2u32) - j;
// //                 let x3 = x3_2 - x3_1;

// //                 let y3_1 = (P256FieldElement::from_literal(2u64) * s1) * j;
// //                 let y3_2 = r * (v - x3);
// //                 let y3 = y3_2 - y3_1;
...
// //     for i in 0..256 {
// //         q = point_double(q);
// //         if k.get_bit(256 - 1 - i).equal(P256Scalar::ONE()) {
...
// //     let (x, y) = p;
// //     let on_curve = y * y == x * x * x - P256FieldElement::from_literal(3u64) * x + b;
