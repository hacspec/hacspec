...
fn aes_128_enc_dec_test(m: &ByteSeq, key: Key128, iv: Aes128Nonce, ctr: U32, ctxt: Option<&ByteSeq>) {
...
fn test_enc_dec() {
    ...
    let iv = Aes128Nonce::from_public_slice(&random_byte_vec(Aes128Nonce::length()));
...
fn test_kat1() {
    ...
    let nonce = Aes128Nonce::from_public_slice(&[
