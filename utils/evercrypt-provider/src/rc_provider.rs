...
pub use aead::{Aead, AeadInPlace, NewAead, Payload};
use evercrypt::aead::{
    key_gen, nonce_gen, Aead as EvercryptAead, Mode, Nonce as EvercryptNonce, Tag as EvercryptTag,
};
// use hacspec_provider::traits::*;

pub struct Chacha20Poly1305RC {
    // key: Key,
    aead: Option<EvercryptAead>,
}

impl Chacha20Poly1305RC {
    pub fn key_gen() -> Key {
...
impl NewAead for Chacha20Poly1305RC {
    type KeySize = U32;
...
impl AeadInPlace for Chacha20Poly1305RC {
    type NonceSize = U12;
    type TagSize = U16;
