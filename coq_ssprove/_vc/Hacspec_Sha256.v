...
Program Definition ch
  ...
  let temp_package_both := (fun temp_inp => 
    let '(x_832 , y_833 , z_834) := temp_inp : uint32 '× uint32 '× uint32 in
...
Program Definition maj
  ...
  let temp_package_both := (fun temp_inp => 
    let '(x_836 , y_837 , z_838) := temp_inp : uint32 '× uint32 '× uint32 in
...
Program Definition sigma
  : both_package (CEfset ([tmp_840_loc])) [interface] [(SIGMA,(
      sigma_inp,sigma_out))] :=
  let temp_package_both := (fun temp_inp => 
    let '(
      x_842 , i_843 , op_844) := temp_inp : uint32 '× uint_size '× uint_size in
    ...
    ((letbm tmp_840 : uint32 loc( tmp_840_loc ) :=
        ...
        letb 'tmp_840 :=
          ...
          then lift_scope (L1 := CEfset ([tmp_840_loc])) (L2 := CEfset (
            [tmp_840_loc])) (I1 := [interface]) (I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (
        ...
        lift_scope (H_loc_incl := _) (H_opsig_incl := _) (((
              uint32_rotate_right (lift_to_both0 x_842) (array_index (
                  op_table_v) ((lift_to_both0 (usize 3)) .* (
                    lift_to_both0 i_843)))) .^ (uint32_rotate_right (
                lift_to_both0 x_842) (array_index (op_table_v) (((
                      lift_to_both0 (usize 3)) .* (lift_to_both0 i_843)) .+ (
                    lift_to_both0 (usize 1)))))) .^ (lift_to_both0 tmp_840))
        ) : both (CEfset ([tmp_840_loc])) [interface] (uint32)))in
...
Program Definition schedule
  ...
  let temp_package_both := (fun temp_inp => 
    ...
    ((letb b_849 : seq uint32 :=
        ...
        letb s_846 :=
          foldi_both' (lift_to_both0 (usize 0)) (
            ...
            letb 's_846 :=
              ...
              else  lift_scope (L1 := CEfset ([s_846_loc])) (L2 := CEfset (
                [s_846_loc])) (I1 := [interface
              #val #[ SIGMA ] : sigma_inp → sigma_out ]) (I2 := [interface
              #val #[ SIGMA ] : sigma_inp → sigma_out
              ]) (H_loc_incl := _) (H_opsig_incl := _) (letb t16_851 : uint32 :=
        ...
        ) : both (CEfset ([s_846_loc])) [interface
...
Program Definition shuffle
  ...
  let temp_package_both := (fun temp_inp => 
    ...
    ((letbm h_858 : hash_t loc( h_858_loc ) := lift_to_both0 hashi_860 in
        letb h_858 :=
          foldi_both' (lift_to_both0 (usize 0)) (
              lift_to_both0 k_size_v) h_858 (L := (CEfset (
                [h_858_loc]))) (I := ([interface
              #val #[ CH ] : ch_inp → ch_out ;
              #val #[ MAJ ] : maj_inp → maj_out ;
              #val #[ SIGMA ] : sigma_inp → sigma_out ])) (fun i_861 h_858 =>
            letb a0_862 : uint32 :=
        ...
        ) : both (CEfset ([h_858_loc])) [interface
      #val #[ CH ] : ch_inp → ch_out ; #val #[ MAJ ] : maj_inp → maj_out ;
    ...
    ((letb s_877 : round_constants_table_t :=
        ...
        letb h_874 :=
          foldi_both' (lift_to_both0 (usize 0)) (lift_to_both0 (
                usize 8)) h_874 (L := (CEfset ([h_874_loc]))) (I := ([interface
              #val #[ SCHEDULE ] : schedule_inp → schedule_out ;
        ...
        ) : both (CEfset ([h_874_loc])) [interface
      #val #[ SCHEDULE ] : schedule_inp → schedule_out ;
...
Program Definition hash
  : both_package (CEfset (
      [h_881_loc ; last_block_882_loc ; last_block_len_883_loc ; pad_block_884_loc])) [interface
  #val #[ COMPRESS ] : compress_inp → compress_out ] [(HASH,(
      hash_inp,hash_out))] :=
  let temp_package_both := (fun temp_inp => 
    let '(msg_889) := temp_inp : byte_seq in
    ...
    ((letbm h_881 : hash_t loc( h_881_loc ) := lift_to_both0 hash_init_v in
        ...
        letb '(h_881, last_block_882, last_block_len_883) :=
          foldi_both' (lift_to_both0 (usize 0)) (seq_num_chunks (
              ...
              last_block_len_883
                ...
                [h_881_loc ; last_block_882_loc ; last_block_len_883_loc ; pad_block_884_loc]))) (I := (
              [interface #val #[ COMPRESS ] : compress_inp → compress_out
              ])) (fun i_890 '(h_881, last_block_882, last_block_len_883) =>
            ...
            letb '(h_881, last_block_882, last_block_len_883) :=
              ...
              then lift_scope (L1 := CEfset (
                [h_881_loc ; last_block_882_loc ; last_block_len_883_loc])) (L2 := CEfset (
                [h_881_loc ; last_block_882_loc ; last_block_len_883_loc])) (I1 := [interface]) (I2 := [interface
              #val #[ COMPRESS ] : compress_inp → compress_out
                ...
                [h_881_loc ; last_block_882_loc ; last_block_len_883_loc])) (L2 := CEfset (
                [h_881_loc ; last_block_882_loc ; last_block_len_883_loc])) (I1 := [interface
              #val #[ COMPRESS ] : compress_inp → compress_out
              ]) (I2 := [interface
              #val #[ COMPRESS ] : compress_inp → compress_out
              ]) (H_loc_incl := _) (H_opsig_incl := _) (
        ...
        letb '(h_881, last_block_882) :=
          ...
          then lift_scope (L1 := CEfset (
            [h_881_loc ; last_block_882_loc ; last_block_len_883_loc])) (L2 := CEfset (
            [h_881_loc ; last_block_882_loc ; last_block_len_883_loc ; pad_block_884_loc])) (I1 := [interface
          #val #[ COMPRESS ] : compress_inp → compress_out
          ]) (I2 := [interface
          #val #[ COMPRESS ] : compress_inp → compress_out
          ]) (H_loc_incl := _) (H_opsig_incl := _) (
            ...
            [h_881_loc ; last_block_882_loc ; last_block_len_883_loc ; pad_block_884_loc])) (L2 := CEfset (
            [h_881_loc ; last_block_882_loc ; last_block_len_883_loc ; pad_block_884_loc])) (I1 := [interface
          #val #[ COMPRESS ] : compress_inp → compress_out
          ]) (I2 := [interface
          #val #[ COMPRESS ] : compress_inp → compress_out
        ...
        lift_scope (H_loc_incl := _) (H_opsig_incl := _) (array_from_seq (
          ...
          [h_881_loc ; last_block_882_loc ; last_block_len_883_loc ; pad_block_884_loc])) [interface
      #val #[ COMPRESS ] : compress_inp → compress_out ] (sha256_digest_t)))in
...
Program Definition sha256
  ...
  ] [(SHA256,(sha256_inp,sha256_out))] :=
  let temp_package_both := (fun temp_inp => 
    let '(msg_896) := temp_inp : byte_seq in
  ...
  both_package' _ _ (SHA256,(sha256_inp,sha256_out)) temp_package_both.
Fail Next Obligation.
