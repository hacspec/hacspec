...
Program Definition jacobian_to_affine
  : both_package (fset.fset0) [interface] [(JACOBIAN_TO_AFFINE,(
      jacobian_to_affine_inp,jacobian_to_affine_out))] :=
  let temp_package_both := (fun temp_inp => 
    let '(p_720) := temp_inp : p256_jacobian_t in
    ...
    ((letb '(x_721, y_722, z_723) : (
        ...
        ) : both (fset.fset0) [interface] (affine_t)))in
  both_package' _ _ (JACOBIAN_TO_AFFINE,(
      jacobian_to_affine_inp,jacobian_to_affine_out)) temp_package_both.
...
Program Definition affine_to_jacobian
  : both_package (fset.fset0) [interface] [(AFFINE_TO_JACOBIAN,(
      affine_to_jacobian_inp,affine_to_jacobian_out))] :=
  let temp_package_both := (fun temp_inp => 
    let '(p_731) := temp_inp : affine_t in
    ...
    ((letb '(x_732, y_733) : (p256_field_element_t '× p256_field_element_t) :=
        ...
        ) : both (fset.fset0) [interface] (p256_jacobian_t)))in
  both_package' _ _ (AFFINE_TO_JACOBIAN,(
      affine_to_jacobian_inp,affine_to_jacobian_out)) temp_package_both.
Fail Next Obligation.
...
Program Definition point_double
  : both_package (fset.fset0) [interface] [(POINT_DOUBLE,(
      point_double_inp,point_double_out))] :=
  let temp_package_both := (fun temp_inp => 
    let '(p_735) := temp_inp : p256_jacobian_t in
    ...
    ((letb '(x1_736, y1_737, z1_738) : (
        ...
        letb alpha_744 : p256_field_element_t :=
          (nat_mod_from_literal (
              0xffffffff00000001000000000000000000000000ffffffffffffffffffffffff) (
              lift_to_both0 (@repr U128 3))) *% ((
              lift_to_both0 alpha_1_742) *% (lift_to_both0 alpha_2_743)) in
  ...
  both_package' _ _ (POINT_DOUBLE,(
      point_double_inp,point_double_out)) temp_package_both.
Fail Next Obligation.
...
Program Definition is_point_at_infinity
  : both_package (fset.fset0) [interface] [(IS_POINT_AT_INFINITY,(
      is_point_at_infinity_inp,is_point_at_infinity_out))] :=
  let temp_package_both := (fun temp_inp => 
    let '(p_752) := temp_inp : p256_jacobian_t in
  ...
  both_package' _ _ (IS_POINT_AT_INFINITY,(
      is_point_at_infinity_inp,is_point_at_infinity_out)) temp_package_both.
Fail Next Obligation.
...
Program Definition s1_equal_s2
  : both_package (fset.fset0) [interface] [(S1_EQUAL_S2,(
      s1_equal_s2_inp,s1_equal_s2_out))] :=
  let temp_package_both := (fun temp_inp => 
    let '(
      s1_757 , s2_758) := temp_inp : p256_field_element_t '× p256_field_element_t in
    ...
    ((lift_scope (H_loc_incl := _) (H_opsig_incl := _) (
        ...
        ) : both (fset.fset0) [interface] (jacobian_result_t)))in
  both_package' _ _ (S1_EQUAL_S2,(
      s1_equal_s2_inp,s1_equal_s2_out)) temp_package_both.
Fail Next Obligation.
...
Program Definition point_add_jacob
  : both_package (CEfset ([result_760_loc])) [interface
  ...
  #val #[ S1_EQUAL_S2 ] : s1_equal_s2_inp → s1_equal_s2_out ] [(
    POINT_ADD_JACOB,(point_add_jacob_inp,point_add_jacob_out))] :=
  let temp_package_both := (fun temp_inp => 
    let '(p_763 , q_762) := temp_inp : p256_jacobian_t '× p256_jacobian_t in
    
    let is_point_at_infinity := fun x_0 => package_both is_point_at_infinity (
      x_0) in
    let s1_equal_s2 := fun x_0 x_1 => package_both s1_equal_s2 (x_0,x_1) in
    ((letbm result_760 : (result (error_t) (
        ...
        letb 'result_760 :=
          ...
          #val #[ IS_POINT_AT_INFINITY ] : is_point_at_infinity_inp → is_point_at_infinity_out ;
          #val #[ S1_EQUAL_S2 ] : s1_equal_s2_inp → s1_equal_s2_out
          ]) (H_loc_incl := _) (H_opsig_incl := _) (letb 'result_760 :=
              if is_point_at_infinity (lift_to_both0 q_762) :bool_ChoiceEquality
              then lift_scope (L1 := CEfset ([result_760_loc])) (L2 := CEfset (
                [result_760_loc])) (I1 := [interface]) (I2 := [interface
              #val #[ IS_POINT_AT_INFINITY ] : is_point_at_infinity_inp → is_point_at_infinity_out ;
              #val #[ S1_EQUAL_S2 ] : s1_equal_s2_inp → s1_equal_s2_out
              ...
              #val #[ IS_POINT_AT_INFINITY ] : is_point_at_infinity_inp → is_point_at_infinity_out ;
              #val #[ S1_EQUAL_S2 ] : s1_equal_s2_inp → s1_equal_s2_out
              ]) (H_loc_incl := _) (H_opsig_incl := _) (letb '(
                    x1_764,
                    y1_765,
                    z1_766
                  ) : (
                ...
                letb 'result_760 :=
                  ...
                  #val #[ S1_EQUAL_S2 ] : s1_equal_s2_inp → s1_equal_s2_out
                    ...
                    letbm result_760 loc( result_760_loc ) :=
                      s1_equal_s2 (lift_to_both0 s1_774) (
                        lift_to_both0 s2_775) in
                    lift_scope (H_loc_incl := _) (H_opsig_incl := _) (
                      lift_to_both0 result_760)
                    )
                  ...
                  #val #[ S1_EQUAL_S2 ] : s1_equal_s2_inp → s1_equal_s2_out
                    ...
                    letb z3_787 : p256_field_element_t :=
                      nat_mod_exp ((lift_to_both0 z1_766) +% (
                          lift_to_both0 z2_769)) (lift_to_both0 (
                          @repr U32 2)) in
                    letb z3_788 : p256_field_element_t :=
                      ((lift_to_both0 z3_787) -% ((lift_to_both0 z1z1_770) +% (
                            lift_to_both0 z2z2_771))) *% (
                        lift_to_both0 h_776) in
                    letbm result_760 loc( result_760_loc ) :=
        ...
        lift_scope (H_loc_incl := _) (H_opsig_incl := _) (
          lift_to_both0 result_760)
        ) : both (CEfset ([result_760_loc])) [interface
      #val #[ IS_POINT_AT_INFINITY ] : is_point_at_infinity_inp → is_point_at_infinity_out ;
      #val #[ S1_EQUAL_S2 ] : s1_equal_s2_inp → s1_equal_s2_out ] (
        jacobian_result_t)))in
  both_package' _ _ (POINT_ADD_JACOB,(
      point_add_jacob_inp,point_add_jacob_out)) temp_package_both.
Fail Next Obligation.
...
Program Definition ltr_mul
  : both_package (CEfset ([q_790_loc])) [interface
  #val #[ POINT_ADD_JACOB ] : point_add_jacob_inp → point_add_jacob_out ;
  #val #[ POINT_DOUBLE ] : point_double_inp → point_double_out ] [(LTR_MUL,(
      ltr_mul_inp,ltr_mul_out))] :=
  let temp_package_both := (fun temp_inp => 
    let '(k_793 , p_794) := temp_inp : p256_scalar_t '× p256_jacobian_t in
    
    let point_add_jacob := fun x_0 x_1 => package_both point_add_jacob (
      x_0,x_1) in
    let point_double := fun x_0 => package_both point_double (x_0) in
    ((letbm q_790 : (
            p256_field_element_t '×
            p256_field_element_t '×
            p256_field_element_t
        ...
        letbnd(_) q_790 :=
          foldi_bind_both' (lift_to_both0 (usize 0)) (
              lift_to_both0 bits_v) q_790 (L := (CEfset ([q_790_loc]))) (I := (
              [interface
              #val #[ POINT_ADD_JACOB ] : point_add_jacob_inp → point_add_jacob_out ;
            ...
            letbnd(_) 'q_790 :=
              ...
              then lift_scope (L1 := CEfset ([q_790_loc])) (L2 := CEfset (
                [q_790_loc])) (I1 := [interface
              #val #[ POINT_ADD_JACOB ] : point_add_jacob_inp → point_add_jacob_out
              ]) (I2 := [interface
              #val #[ POINT_ADD_JACOB ] : point_add_jacob_inp → point_add_jacob_out ;
              #val #[ POINT_DOUBLE ] : point_double_inp → point_double_out
              ]) (H_loc_incl := _) (H_opsig_incl := _) (letbndm(_) q_790 :=
        ...
        ) : both (CEfset ([q_790_loc])) [interface
      #val #[ POINT_ADD_JACOB ] : point_add_jacob_inp → point_add_jacob_out ;
      #val #[ POINT_DOUBLE ] : point_double_inp → point_double_out ] (
        jacobian_result_t)))in
  both_package' _ _ (LTR_MUL,(ltr_mul_inp,ltr_mul_out)) temp_package_both.
Fail Next Obligation.
...
Program Definition p256_point_mul
  ...
  #val #[ LTR_MUL ] : ltr_mul_inp → ltr_mul_out ] [(P256_POINT_MUL,(
      p256_point_mul_inp,p256_point_mul_out))] :=
  let temp_package_both := (fun temp_inp => 
    let '(k_796 , p_797) := temp_inp : p256_scalar_t '× affine_t in
    
    let affine_to_jacobian := fun x_0 => package_both affine_to_jacobian (
      x_0) in
    let jacobian_to_affine := fun x_0 => package_both jacobian_to_affine (
      x_0) in
    let ltr_mul := fun x_0 x_1 => package_both ltr_mul (x_0,x_1) in
    ((letbnd(_) jac_798 : p256_jacobian_t :=
      ...
      #val #[ AFFINE_TO_JACOBIAN ] : affine_to_jacobian_inp → affine_to_jacobian_out ;
      #val #[ JACOBIAN_TO_AFFINE ] : jacobian_to_affine_inp → jacobian_to_affine_out ;
      #val #[ LTR_MUL ] : ltr_mul_inp → ltr_mul_out ] (affine_result_t)))in
  both_package' _ _ (P256_POINT_MUL,(
      p256_point_mul_inp,p256_point_mul_out)) temp_package_both.
Fail Next Obligation.
...
Program Definition p256_point_mul_base
  ...
  #val #[ P256_POINT_MUL ] : p256_point_mul_inp → p256_point_mul_out ] [(
    P256_POINT_MUL_BASE,(p256_point_mul_base_inp,p256_point_mul_base_out))] :=
  let temp_package_both := (fun temp_inp => 
    let '(k_801) := temp_inp : p256_scalar_t in
    ...
    ((letb base_point_800 : (p256_field_element_t '× p256_field_element_t) :=
      ...
      #val #[ P256_POINT_MUL ] : p256_point_mul_inp → p256_point_mul_out ] (
        affine_result_t)))in
  both_package' _ _ (P256_POINT_MUL_BASE,(
      p256_point_mul_base_inp,p256_point_mul_base_out)) temp_package_both.
Fail Next Obligation.
...
Program Definition point_add_distinct
  ...
  #val #[ JACOBIAN_TO_AFFINE ] : jacobian_to_affine_inp → jacobian_to_affine_out ;
  #val #[ POINT_ADD_JACOB ] : point_add_jacob_inp → point_add_jacob_out ] [(
    POINT_ADD_DISTINCT,(point_add_distinct_inp,point_add_distinct_out))] :=
  let temp_package_both := (fun temp_inp => 
    let '(p_803 , q_804) := temp_inp : affine_t '× affine_t in
  ...
  both_package' _ _ (POINT_ADD_DISTINCT,(
      point_add_distinct_inp,point_add_distinct_out)) temp_package_both.
Fail Next Obligation.
...
Program Definition point_add
  ...
  #val #[ POINT_DOUBLE ] : point_double_inp → point_double_out ] [(POINT_ADD,(
      point_add_inp,point_add_out))] :=
  let temp_package_both := (fun temp_inp => 
    let '(p_807 , q_808) := temp_inp : affine_t '× affine_t in
    
    let affine_to_jacobian := fun x_0 => package_both affine_to_jacobian (
      x_0) in
    let jacobian_to_affine := fun x_0 => package_both jacobian_to_affine (
      x_0) in
    let point_add_distinct := fun x_0 x_1 => package_both point_add_distinct (
      x_0,x_1) in
    let point_double := fun x_0 => package_both point_double (x_0) in
    ((lift_scope (H_loc_incl := _) (H_opsig_incl := _) (
...
Program Definition p256_validate_private_key
  : both_package (CEfset ([valid_810_loc ; all_zero_811_loc])) [interface] [(
    P256_VALIDATE_PRIVATE_KEY,(
      p256_validate_private_key_inp,p256_validate_private_key_out))] :=
  let temp_package_both := (fun temp_inp => 
    let '(k_814) := temp_inp : byte_seq in
    ...
    ((letbm valid_810 : bool_ChoiceEquality loc( valid_810_loc ) :=
        ...
        letb '(valid_810, all_zero_811) :=
          foldi_both' (lift_to_both0 (usize 0)) (seq_len (
              ...
              CEfset ([valid_810_loc ; all_zero_811_loc]))) (I := (
              [interface])) (fun i_817 '(valid_810, all_zero_811) =>
            letb 'all_zero_811 :=
              ...
              then lift_scope (L1 := CEfset (
                ...
                [valid_810_loc ; all_zero_811_loc])) (I1 := [interface]) (I2 := [interface]) (H_loc_incl := _) (H_opsig_incl := _) (
  ...
  both_package' _ _ (P256_VALIDATE_PRIVATE_KEY,(
      p256_validate_private_key_inp,p256_validate_private_key_out)) temp_package_both.
Fail Next Obligation.
...
Program Definition p256_validate_public_key
  ...
  #val #[ IS_POINT_AT_INFINITY ] : is_point_at_infinity_inp → is_point_at_infinity_out
      ...
      p256_validate_public_key_inp,p256_validate_public_key_out))] :=
  let temp_package_both := (fun temp_inp => 
    let '(p_820) := temp_inp : affine_t in
        ...
        letb on_curve_824 : bool_ChoiceEquality :=
          ((lift_to_both0 y_823) *% (lift_to_both0 y_823)) =.? (((((
                  ...
                  lift_to_both0 x_822)) -% ((nat_mod_from_literal (
                    0xffffffff00000001000000000000000000000000ffffffffffffffffffffffff) (
                    lift_to_both0 (@repr U128 3))) *% (
                  lift_to_both0 x_822))) +% (lift_to_both0 b_819)) in
  ...
  both_package' _ _ (P256_VALIDATE_PUBLIC_KEY,(
      p256_validate_public_key_inp,p256_validate_public_key_out)) temp_package_both.
Fail Next Obligation.
...
Program Definition p256_calculate_w
  : both_package (fset.fset0) [interface] [(P256_CALCULATE_W,(
      p256_calculate_w_inp,p256_calculate_w_out))] :=
  let temp_package_both := (fun temp_inp => 
    let '(x_828) := temp_inp : p256_field_element_t in
    ...
    ((letb b_826 : p256_field_element_t :=
        ...
        ) : both (fset.fset0) [interface] (p256_field_element_t)))in
  both_package' _ _ (P256_CALCULATE_W,(
      p256_calculate_w_inp,p256_calculate_w_out)) temp_package_both.
Fail Next Obligation.
