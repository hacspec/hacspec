      ...
      letb x3_245 : int128 :=
        ((lift_to_both0 v1_243) shift_right (lift_to_both0 (usize 96))) .% ((
            lift_to_both0 (@repr U128 1)) shift_left (lift_to_both0 (
              usize 32))) in
      letb y0_246 : int32 :=
        subword ((fun x => repr (unsigned x)) (lift_to_both0 x1_244)) in
      letb y1_248 : int32 :=
        (ror (subword ((fun x => repr (unsigned x)) (lift_to_both0 x1_244))) (
            lift_to_both0 (usize 1))) .^ ((fun x => repr (unsigned x)) (
            lift_to_both0 v2_247)) in
      letb y2_249 : int32 :=
        subword ((fun x => repr (unsigned x)) (lift_to_both0 x3_245)) in
      letb y3_250 : int32 :=
        (ror (subword ((fun x => repr (unsigned x)) (lift_to_both0 x3_245))) (
            lift_to_both0 (usize 1))) .^ ((fun x => repr (unsigned x)) (
            lift_to_both0 v2_247)) in
      lift_scope (H_loc_incl := _) (H_opsig_incl := _) (((((fun x => repr (unsigned x)) (
                lift_to_both0 y0_246)) .| (((fun x => repr (unsigned x)) (
                  lift_to_both0 y1_248)) shift_left (lift_to_both0 (
                  usize 32)))) .| (((fun x => repr (unsigned x)) (
                lift_to_both0 y2_249)) shift_left (lift_to_both0 (
                usize 64)))) .| (((fun x => repr (unsigned x)) (
