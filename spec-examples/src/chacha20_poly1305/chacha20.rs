...
pub fn block_init(key: Key, ctr: U32, iv: IV) -> State {
    State([
        ...
        U32(0x7962_2d32),
        U32(0x6b20_6574),
        U32_from_le_bytes(U32Word::from_subr(key, 0..4)),
        U32_from_le_bytes(U32Word::from_subr(key, 4..8)),
        U32_from_le_bytes(U32Word::from_subr(key, 8..12)),
        U32_from_le_bytes(U32Word::from_subr(key, 12..16)),
        U32_from_le_bytes(U32Word::from_subr(key, 16..20)),
        U32_from_le_bytes(U32Word::from_subr(key, 20..24)),
        U32_from_le_bytes(U32Word::from_subr(key, 24..28)),
        U32_from_le_bytes(U32Word::from_subr(key, 28..32)),
        ctr,
        U32_from_le_bytes(U32Word::from_subr(iv, 0..4)),
        U32_from_le_bytes(U32Word::from_subr(iv, 4..8)),
        U32_from_le_bytes(U32Word::from_subr(iv, 8..12)),
    ])
}
