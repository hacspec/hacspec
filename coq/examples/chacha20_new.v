...
Definition state_to_bytes (x_0 : state) : state_bytes :=
  let r_1 := array_new_ (secret (0)) (64) in
  let r_1 :=
...
Definition chacha_double_round (state_18 : state) : state :=
  let state_19 :=
...
Definition chacha20_constants_init () : list uint32 :=
  let constants_26 := list_new_ (secret (0)) (usize 4) in
  let constants_26 := array_upd constants_26 (usize 0) (secret (1634760805)) in
  let constants_26 := array_upd constants_26 (usize 1) (secret (857760878)) in
  let constants_26 := array_upd constants_26 (usize 2) (secret (2036477234)) in
  let constants_26 := array_upd constants_26 (usize 3) (secret (1797285236)) in
  constants_26.

Definition chacha20_key_to_u32s (key_27 : key) : list uint32 :=
  let uints_28 := list_new_ (secret (0)) (usize 8) in
  let uints_28 :=
    array_upd uints_28 (usize 0) (
      uint32_from_le_bytes (
        array_from_slice_range (secret (0)) (4) (key_27) ((usize 0, usize 4))))
  in
  let uints_28 :=
    array_upd uints_28 (usize 1) (
      uint32_from_le_bytes (
        array_from_slice_range (secret (0)) (4) (key_27) ((usize 4, usize 8))))
  in
  let uints_28 :=
    array_upd uints_28 (usize 2) (
      uint32_from_le_bytes (
        array_from_slice_range (secret (0)) (4) (key_27) ((usize 8, usize 12))))
  in
  let uints_28 :=
    array_upd uints_28 (usize 3) (
      uint32_from_le_bytes (
        array_from_slice_range (secret (0)) (4) (key_27) (
          (usize 12, usize 16))))
  in
  let uints_28 :=
...
Definition chacha20_iv_to_u32s (iv_29 : iv) : list uint32 :=
  let uints_30 := list_new_ (secret (0)) (usize 3) in
  let uints_30 :=
    array_upd uints_30 (usize 0) (
      uint32_from_le_bytes (
        array_from_slice_range (secret (0)) (4) (iv_29) ((usize 0, usize 4))))
  in
  let uints_30 :=
    array_upd uints_30 (usize 1) (
      uint32_from_le_bytes (
        array_from_slice_range (secret (0)) (4) (iv_29) ((usize 4, usize 8))))
  in
  let uints_30 :=
    array_upd uints_30 (usize 2) (
      uint32_from_le_bytes (
        array_from_slice_range (secret (0)) (4) (iv_29) ((usize 8, usize 12))))
  in
  uints_30.

Definition chacha20_ctr_to_seq (ctr_31 : uint32) : list uint32 :=
  let uints_32 := list_new_ (secret (0)) (usize 1) in
  let uints_32 := array_upd uints_32 (usize 0) (ctr_31) in
  uints_32.

Definition chacha_block_init
  (key_33 : key)
  (ctr_34 : uint32)
  (iv_35 : iv)
  : state :=
...
Definition chacha (key_47 : key) (iv_48 : iv) (m_49 : byte_seq) : byte_seq :=
  let ctr_50 := secret (1) in
  let blocks_out_51 := list_new_ (secret (0)) (list_len (m_49)) in
  let (ctr_50, blocks_out_51) :=
    foldi (usize 0) (list_num_chunks (m_49) (usize 64)) (fun i_52 (
      ...
      let msg_block_padded_56 := array_new_ (secret (0)) (64) in
