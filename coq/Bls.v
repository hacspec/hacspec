...
Definition fp2mul (n_14 : fp2) (m_15 : fp2) : fp2 :=
  ...
  in
  let x1_20 :=
    ((n1_16) *% (m1_18)) -% ((n2_17) *% (m2_19))
  in
  let x2_21 :=
    ((n1_16) *% (m2_19)) +% ((n2_17) *% (m1_18))
  in
  (x1_20, x2_21).
...
Definition fp6mul (n_47 : fp6) (m_48 : fp6) : fp6 :=
  ...
  in
  let t4_59 :=
    fp2mul (fp2add (n2_50) (n3_51)) (fp2add (m2_53) (m3_54))
  in
  let t5_60 :=
    fp2sub (fp2sub (t4_59) (t2_57)) (t3_58)
  in
  let x_61 :=
    fp2add (fp2mul (t5_60) (eps_55)) (t1_56)
  in
  let t4_62 :=
    fp2mul (fp2add (n1_49) (n2_50)) (fp2add (m1_52) (m2_53))
  in
  let t5_63 :=
    fp2sub (fp2sub (t4_62) (t1_56)) (t2_57)
  in
  let y_64 :=
    fp2add (t5_63) (fp2mul (eps_55) (t3_58))
  in
  let t4_65 :=
    fp2mul (fp2add (n1_49) (n3_51)) (fp2add (m1_52) (m3_54))
  in
  let t5_66 :=
    fp2sub (fp2sub (t4_65) (t1_56)) (t3_58)
  in
  let z_67 :=
    fp2add (t5_66) (t2_57)
  in
...
Definition fp6inv (n_68 : fp6) : fp6 :=
  ...
  in
  let x0_79 :=
    fp2sub (t1_73) (fp2mul (eps_72) (t6_78))
  in
  let y0_80 :=
    fp2sub (fp2mul (eps_72) (t3_75)) (t4_76)
  in
  let z0_81 :=
    fp2sub (t2_74) (t5_77)
  in
  ...
  in
  let t0_83 :=
    fp2add (t0_82) (fp2mul (eps_72) (fp2mul (n3_71) (y0_80)))
  in
  let t0_84 :=
    fp2add (t0_83) (fp2mul (eps_72) (fp2mul (n2_70) (z0_81)))
  in
  let t0_85 :=
    fp2inv (t0_84)
  in
...
Definition fp12mul (n_101 : fp12) (m_102 : fp12) : fp12 :=
  ...
  in
  let gamma_107 :=
    (fp2zero , fp2fromfp (nat_mod_one ), fp2zero )
  in
  let t1_108 :=
    fp6mul (n1_103) (m1_105)
  in
  let t2_109 :=
    fp6mul (n2_104) (m2_106)
  in
  let x_110 :=
    fp6add (t1_108) (fp6mul (t2_109) (gamma_107))
  in
  let y_111 :=
    fp6mul (fp6add (n1_103) (n2_104)) (fp6add (m1_105) (m2_106))
  in
  let y_112 :=
    fp6sub (fp6sub (y_111) (t1_108)) (t2_109)
  in
  (x_110, y_112).
...
Definition fp12inv (n_113 : fp12) : fp12 :=
  ...
  in
  let t1_117 :=
    fp6mul (n1_114) (n1_114)
  in
  let t2_118 :=
    fp6mul (n2_115) (n2_115)
  in
  let t1_119 :=
    fp6sub (t1_117) (fp6mul (gamma_116) (t2_118))
  in
  let t2_120 :=
    fp6inv (t1_119)
  in
  let x_121 :=
    fp6mul (n1_114) (t2_120)
  in
  let y_122 :=
    fp6neg (fp6mul (n2_115) (t2_120))
  in
  (x_121, y_122).

Definition fp12exp (n_123 : fp12) (k_124 : scalar) : fp12 :=
  let l_125 :=
    (usize 255) - (most_significant_bit (k_124) (usize 255))
  in
  let c_126 :=
    n_123
  in
...
Definition g1add_a (p_131 : g1) (q_132 : g1) : g1 :=
  ...
  in
  let xovery_139 :=
    (y_diff_138) *% (nat_mod_inv (x_diff_137))
  in
  let x3_140 :=
    ((nat_mod_exp (xovery_139) (repr 2)) -% (x1_133)) -% (x2_135)
  in
  let y3_141 :=
    ((xovery_139) *% ((x1_133) -% (x3_140))) -% (y1_134)
  in
  (x3_140, y3_141, false).
...
Definition g1double_a (p_142 : g1) : g1 :=
  ...
  in
  let y3_148 :=
    ((xovery_146) *% ((x1_143) -% (x3_147))) -% (y1_144)
  in
  (x3_147, y3_148, false).
...
Definition g1mul (m_161 : scalar) (p_162 : g1) : g1 :=
  ...
  in
  let k_164 :=
    (n_163) - (most_significant_bit (m_161) (n_163))
  in
  let t_165 :=
    p_162
  in
...
Definition g2add_a (p_171 : g2) (q_172 : g2) : g2 :=
  ...
  in
  let x_diff_177 :=
    fp2sub (x2_175) (x1_173)
  in
  let y_diff_178 :=
    fp2sub (y2_176) (y1_174)
  in
  let xovery_179 :=
    fp2mul (y_diff_178) (fp2inv (x_diff_177))
  in
  let t1_180 :=
    fp2mul (xovery_179) (xovery_179)
  in
  let t2_181 :=
    fp2sub (t1_180) (x1_173)
  in
  let x3_182 :=
    fp2sub (t2_181) (x2_175)
  in
  let t1_183 :=
    fp2sub (x1_173) (x3_182)
  in
  let t2_184 :=
    fp2mul (xovery_179) (t1_183)
  in
  let y3_185 :=
    fp2sub (t2_184) (y1_174)
  in
  (x3_182, y3_185, false).
...
Definition g2double_a (p_186 : g2) : g2 :=
  ...
  in
  let t2_191 :=
    fp2inv (fp2mul (fp2fromfp (nat_mod_two )) (y1_188))
  in
  let xovery_192 :=
    fp2mul (t1_190) (t2_191)
  in
  let t1_193 :=
    fp2mul (xovery_192) (xovery_192)
  in
  let t2_194 :=
    fp2mul (fp2fromfp (nat_mod_two )) (x1_187)
  in
  let x3_195 :=
    fp2sub (t1_193) (t2_194)
  in
  let t1_196 :=
    fp2sub (x1_187) (x3_195)
  in
  let t2_197 :=
    fp2mul (xovery_192) (t1_196)
  in
  let y3_198 :=
    fp2sub (t2_197) (y1_188)
  in
  (x3_195, y3_198, false).
...
Definition g2mul (m_211 : scalar) (p_212 : g2) : g2 :=
  ...
  in
  let k_214 :=
    (n_213) - (most_significant_bit (m_211) (n_213))
  in
  let t_215 :=
    p_212
  in
...
Definition twist (p_221 : g1) : (fp12 × fp12) :=
  ...
  in
  let x_224 :=
    ((fp2zero , fp2fromfp (p0_222), fp2zero ), fp6zero )
  in
  let y_225 :=
    (fp6zero , (fp2zero , fp2fromfp (p1_223), fp2zero ))
  in
  (x_224, y_225).
...
Definition line_double_p (r_226 : g2) (p_227 : g1) : fp12 :=
  ...
  in
  let b_232 :=
    fp2sub (r1_229) (fp2mul (a_231) (r0_228))
  in
  let a_233 :=
    fp12fromfp6 (fp6fromfp2 (a_231))
  in
  let b_234 :=
    fp12fromfp6 (fp6fromfp2 (b_232))
  in
  let '(x_235, y_236) :=
    twist (p_227)
  in
...
Definition line_add_p (r_237 : g2) (q_238 : g2) (p_239 : g1) : fp12 :=
  ...
  in
  let b_245 :=
    fp2sub (r1_241) (fp2mul (a_244) (r0_240))
  in
  let a_246 :=
    fp12fromfp6 (fp6fromfp2 (a_244))
  in
  let b_247 :=
    fp12fromfp6 (fp6fromfp2 (b_245))
  in
  let '(x_248, y_249) :=
    twist (p_239)
  in
...
Definition frobenius (f_250 : fp12) : fp12 :=
  ...
  in
  let c1_264 :=
    array_to_le_bytes (c1_263)
  in
  let c1_265 :=
    nat_mod_from_byte_seq_le (c1_264)
  in
  let c2_266 :=
    array_from_list uint64 (
      let l :=
  ...
  in
  let c2_267 :=
    array_to_le_bytes (c2_266)
  in
  let c2_268 :=
    nat_mod_from_byte_seq_le (c2_267)
  in
  let gamma11_269 :=
    (c1_265, c2_268)
  in
  let gamma12_270 :=
    fp2mul (gamma11_269) (gamma11_269)
  in
  let gamma13_271 :=
    fp2mul (gamma12_270) (gamma11_269)
  in
  let gamma14_272 :=
    fp2mul (gamma13_271) (gamma11_269)
  in
  let gamma15_273 :=
    fp2mul (gamma14_272) (gamma11_269)
  in
  let t2_274 :=
    fp2mul (t2_258) (gamma11_269)
  in
  let t3_275 :=
    fp2mul (t3_259) (gamma12_270)
  in
  let t4_276 :=
    fp2mul (t4_260) (gamma13_271)
  in
  let t5_277 :=
    fp2mul (t5_261) (gamma14_272)
  in
  let t6_278 :=
    fp2mul (t6_262) (gamma15_273)
  in
...
Definition final_exponentiation (f_279 : fp12) : fp12 :=
  ...
  in
  let fp6_1_282 :=
    fp12mul (fp6_280) (finv_281)
  in
  let fp8_283 :=
    frobenius (frobenius (fp6_1_282))
  in
  let f_284 :=
    fp12mul (fp8_283) (fp6_1_282)
  in
  let u_285 :=
    nat_mod_from_literal (
  ...
  in
  let t1_287 :=
    fp12exp (t0_286) (u_285)
  in
  let t1_288 :=
    fp12conjugate (t1_287)
  in
  let t2_289 :=
    fp12exp (t1_288) ((u_285) /% (nat_mod_two ))
  in
  let t2_290 :=
    fp12conjugate (t2_289)
  in
  let t3_291 :=
    fp12conjugate (f_284)
  in
  let t1_292 :=
    fp12mul (t3_291) (t1_288)
  in
  let t1_293 :=
    fp12conjugate (t1_292)
  in
  let t1_294 :=
    fp12mul (t1_293) (t2_290)
  in
  let t2_295 :=
    fp12exp (t1_294) (u_285)
  in
  let t2_296 :=
    fp12conjugate (t2_295)
  in
  let t3_297 :=
    fp12exp (t2_296) (u_285)
  in
  let t3_298 :=
    fp12conjugate (t3_297)
  in
  let t1_299 :=
    fp12conjugate (t1_294)
  in
  let t3_300 :=
    fp12mul (t1_299) (t3_298)
  in
  let t1_301 :=
    fp12conjugate (t1_299)
  in
  let t1_302 :=
    frobenius (frobenius (frobenius (t1_301)))
  in
  let t2_303 :=
    frobenius (frobenius (t2_296))
  in
  let t1_304 :=
    fp12mul (t1_302) (t2_303)
  in
  let t2_305 :=
    fp12exp (t3_300) (u_285)
  in
  let t2_306 :=
    fp12conjugate (t2_305)
  in
  let t2_307 :=
    fp12mul (t2_306) (t0_286)
  in
  let t2_308 :=
    fp12mul (t2_307) (f_284)
  in
  let t1_309 :=
    fp12mul (t1_304) (t2_308)
  in
  let t2_310 :=
    frobenius (t3_300)
  in
  let t1_311 :=
    fp12mul (t1_309) (t2_310)
  in
  t1_311.
...
Definition pairing (p_312 : g1) (q_313 : g2) : fp12 :=
  ...
  let '(r_315, f_316) :=
    foldi (usize 1) (usize 64) (fun i_317 '(r_315, f_316) =>
      let lrr_318 :=
        line_double_p (r_315) (p_312)
      in
      let r_315 :=
        g2double (r_315)
      in
      let f_316 :=
        fp12mul (fp12mul (f_316) (f_316)) (lrr_318)
      in
      let '(r_315, f_316) :=
        if nat_mod_bit (t_314) (((usize 64) - (i_317)) - (usize 1)):bool then (
          let lrq_319 :=
            line_add_p (r_315) (q_313) (p_312)
          in
          let r_315 :=
            g2add (r_315) (q_313)
          in
          let f_316 :=
            fp12mul (f_316) (lrq_319)
          in
          (r_315, f_316)
        ) else ( (r_315, f_316)
        )
