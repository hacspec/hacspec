...
Definition chacha20_constants_init  : constants :=
  let constants_29 := array_new_ (secret (repr 0)) (4) in
  let constants_29 :=
    array_upd constants_29 (usize 0) (secret (repr 1634760805))
  in
  let constants_29 :=
    array_upd constants_29 (usize 1) (secret (repr 857760878))
  in
  let constants_29 :=
    array_upd constants_29 (usize 2) (secret (repr 2036477234))
  in
  let constants_29 :=
    array_upd constants_29 (usize 3) (secret (repr 1797285236))
  in
  constants_29.
...
Definition chacha20_init
  ...
  (ctr_32 : uint32)
  : state :=
  let st_33 := array_new_ (secret (repr 0)) (16) in
...
Definition chacha20_key_block (state_34 : state) : block :=
  let state_35 := chacha20_core (secret (repr 0)) (state_34) in
...
Definition chacha20_key_block0
  ...
  (iv_37 : cha_cha_iv)
  : block :=
  let state_38 := chacha20_init (key_36) (iv_37) (secret (repr 0)) in
...
Definition chacha20_encrypt_last
  ...
  (plain_47 : byte_seq)
  : byte_seq :=
  let b_48 := array_new_ (secret (repr 0)) (64) in
...
Definition chacha20_update (st0_49 : state) (m_50 : byte_seq) : byte_seq :=
  let blocks_out_51 := seq_new_ (secret (repr 0)) (seq_len (m_50)) in
