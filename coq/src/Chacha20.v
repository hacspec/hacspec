...
Definition chacha20_key_block (state_34 : state) : block :=
  let state_35 :=
    chacha20_core (secret (repr 0)) (state_34)
  in
...
Definition chacha20_key_block0
  ...
  : block :=
  let state_38 :=
    chacha20_init (key_36) (iv_37) (secret (repr 0))
  in
...
Definition chacha20_update (st0_49 : state) (m_50 : byte_seq) : byte_seq :=
  let blocks_out_51 :=
    seq_new_ (secret (repr 0)) (seq_len (m_50))
  in
  let n_blocks_52 :=
